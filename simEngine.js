...
const strategyModule = (typeof globalThis !== 'undefined' && globalThis.VentureStrategyModule)
  ? globalThis.VentureStrategyModule
  : {};
const {
...
if (!computeHypergrowthFairValue || !HypergrowthStrategy || !createVentureStrategy) {
  throw new Error('Venture strategy module failed to load. Ensure ventureStrategies.js is included before simEngine.js.');
}
